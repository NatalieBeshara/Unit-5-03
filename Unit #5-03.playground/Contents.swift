...
// Created for: ICS3U
// This program finds the lowest number out of 10 random numbers
...
class ViewController : UIViewController {
    ...
    func findHighestNumber(randomNumberArrayNumbers: [Int]) -> Int {
        ...
        var smallestNumber : Int = randomNumberArrayNumbers[0]
        
        for randomNumber in randomNumberArrayNumbers{
    ...
    @objc func calculateAverage() {
        ...
        answerLabel.text = "The smallest number is \(highestNumber)."
    }
